...
public class DuelRoutineController : MonoBehaviour
{
    ...
    {
        playerInstance.GetComponent<SpriteRenderer>().color = PlayerManager.GetPlayerColor(PhotonNetwork.LocalPlayer);
